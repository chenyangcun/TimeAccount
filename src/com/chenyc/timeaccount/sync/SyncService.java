package com.chenyc.timeaccount.sync;
...
import com.chenyc.timeaccount.Settings;
...
public class SyncService extends Service {
	...
	private String getBody(String type, String method, long pid) {
		...
		if ("delete".equals(method)) {
			...
			if ("eventtype".equals(type)) {
				...
				mCursor = getContentResolver().query(
						Uri.withAppendedPath(TimeAccount.TIME_ITEM_CONTENT_URI,
								"/" + pid),
	...
	private Cursor getNeedSyncLog() {
		...
		Cursor cursor = (Cursor) getContentResolver().query(
				TimeAccount.SYNC_LOG_CONTENT_URI,
	...
	private void updateSyncLogState(long id, String state) {
		...
		getContentResolver().update(
				Uri
						.withAppendedPath(TimeAccount.SYNC_LOG_CONTENT_URI, "/"
	...
	private void deleteSuccessSyncLog() {
		getContentResolver().delete(TimeAccount.SYNC_LOG_CONTENT_URI,
				"state = 1", null);
	}

	// 删除进行过“删除”操作的“新增”或“修改”记录
